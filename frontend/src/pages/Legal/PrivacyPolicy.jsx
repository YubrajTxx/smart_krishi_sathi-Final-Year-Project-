...
const PrivacyPolicy = () => {
    ...
    return (
        <div className="page-container legal-page" style={{ padding: '4rem 2.5rem', maxWidth: '900px', margin: '0 auto' }}>
            ...
            >
                <h1 style={{ fontSize: '3rem', fontWeight: '800', color: 'var(--primary)', marginBottom: '1rem' }}>{t('privacy_policy_title')}</h1>
                <p style={{ color: 'var(--text-light)' }}>{t('last_updated_date')}</p>
            </motion.header>
            ...
            >
                <section style={{ marginBottom: '2.5rem' }}>
                    <h2 style={{ color: '#1e293b', fontSize: '1.5rem', marginBottom: '1rem' }}>{t('privacy_sec1_title')}</h2>
                    <p>{t('privacy_sec1_desc')}</p>
                    <ul style={{ paddingLeft: '1.5rem' }}>
                        <li><strong>{t('privacy_sec1_li1_bold')}</strong>{t('privacy_sec1_li1_text')}</li>
                        <li><strong>{t('privacy_sec1_li2_bold')}</strong>{t('privacy_sec1_li2_text')}</li>
                        <li><strong>{t('privacy_sec1_li3_bold')}</strong>{t('privacy_sec1_li3_text')}</li>
                    </ul>
                </section>

                <section style={{ marginBottom: '2.5rem' }}>
                    <h2 style={{ color: '#1e293b', fontSize: '1.5rem', marginBottom: '1rem' }}>{t('privacy_sec2_title')}</h2>
                ...
                <section style={{ marginBottom: '2.5rem' }}>
                    <h2 style={{ color: '#1e293b', fontSize: '1.5rem', marginBottom: '1rem' }}>{t('privacy_sec3_title')}</h2>
                    <p>{t('privacy_sec3_desc')}</p>
                </section>

                <section>
                    <h2 style={{ color: '#1e293b', fontSize: '1.5rem', marginBottom: '1rem' }}>{t('privacy_sec4_title')}</h2>
